...
public final class ApacheCommonsCollections4TypeAdapterFactory {
	...
	public static final ITypeAdapterFactory<BidiMap<String, Object>> defaultForBidiMap = forBidiMap(
			typeToken -> {
	...
	public static final ITypeAdapterFactory<IterableMap<String, Object>> defaultForIterableMap = forIterableMap(
			typeToken -> {
				...
				if ( rawType == IterableMap.class ) {
					return () -> Builder.forIterableMap(HashedMap::new, iterableMap -> (IterableMap<String, Object>) UnmodifiableMap.unmodifiableMap(iterableMap));
				}
				return () -> {
	...
	public static final ITypeAdapterFactory<MultiValuedMap<String, Object>> defaultForMultiValueMap = forMultiValueMap(
			typeToken -> {
				@SuppressWarnings({ "unchecked", "rawtypes" })
