...
public final class LocalDateTimeTypeAdapter
	...
	public static final class Factory
			extends AbstractRawClassTypeAdapterFactory<LocalDateTime> {
		...
		@Override
		protected TypeAdapter<LocalDateTime> createTypeAdapter(final Gson gson, final TypeToken<? super LocalDateTime> typeToken) {
			return typeAdapter;
		}
