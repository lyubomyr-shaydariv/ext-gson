...
public abstract class AbstractPolymorphicTypeAdapter<T>
	...
	private final IFunction<? super Class<? extends T>, String> classToDiscriminator;
	private final IFunction<? super Class<? extends T>, ? extends TypeAdapter<? super T>> classToTypeAdapter;
	private final IFunction<? super String, ? extends TypeAdapter<? extends T>> discriminatorToTypeAdapter;
	...
	public abstract static class AbstractFactory<T>
		...
		protected AbstractFactory(
				...
				final IFunction<? super Class<? extends T>, String> classToDiscriminator
		) {
			super(klass);
		...
		protected abstract TypeAdapter<T> createTypeAdapter(
				...
				String property,
				IFunction<? super Class<? extends T>, String> classToDiscriminator
		);
	...
	public static final class Streamed<T>
		...
		private Streamed(
				final String property,
				final IFunction<? super Class<? extends T>, String> classToDiscriminator,
				final IFunction<? super Class<? extends T>, ? extends TypeAdapter<? super T>> classToTypeAdapter,
				final IFunction<? super String, ? extends TypeAdapter<? extends T>> discriminatorToTypeAdapter
		) {
	...
	public static final class JsonTree<T>
		...
		private JsonTree(
				...
				final IFunction<? super Class<? extends T>, String> classToDiscriminator,
				final IFunction<? super Class<? extends T>, ? extends TypeAdapter<? super T>> classToTypeAdapter,
				final IFunction<? super String, ? extends TypeAdapter<? extends T>> propertyToTypeAdapter,
