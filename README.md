`ext-gson` is a simple extension library for [Google Gson](https://github.com/google/gson) (2.8.x, 2.9.0, 2.9.1, and later) including a few extensions for the following libraries:
